...
$query = "SELECT id, username, nama_barang, harga_barang, gambar_barang_1 FROM detail_barang WHERE kategori = 'elektronik'";
...
<!-- bagian di bawah ini nanti di hapus ya mx-16 nya ke dauble soal nya -->
    <div class="md:grid md:grid-cols-5 my-10 justify-center gap-x-10 mx-7 md:mx-16"> 
        <div class="md:mx-10 mx-3 col-span-5">
            <h1 class="text-blue font-medium md:text-4xl text-3xl -ml-3 md:mt-20 mt-24">Kategori Elektronik</h1>
        </div>
        <?php
