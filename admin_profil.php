                ...
                <form action="update_profile.php" method="post" id="formEditProfile" class="mt-5">
                  <div class="mb-5">
                    ...
                    <input
                      ...
                      id="username"
                      name="username"
                      class="px-3 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full py-5"
                  ...
                  <div class="mb-5">
                    ...
                    <input
                      ...
                      id="new_password"
                      name="new_password"
                      class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full py-5"
